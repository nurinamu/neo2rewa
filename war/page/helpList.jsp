...
/*
      ...
      .marketing p + h4 {
        ...
        <table border="0">
          <tr>
            <td colspan="2">
              <textarea style="border:0px;">24호 태풍 너글이로 인해 고담구 일대에 침수 피해가 발생하였습니다.<br><br>현재까지 피해 규모는 23헥타르로 구역내 200 가구에서 수재민이 발생 하였습니다.</textarea>
            </td>
            <td rowspan="6">
              <img src=""/>지도
            </td>
            ...
            <div class="panel panel-default">
              ...
              <div id="collapseOne" class="panel-collapse collapse in">
                <div class="panel-body">
                  <table>
                    <tr>
                      <td colspan="2">수재민들이 마실 식수가 부족합니다. 생수를 지원해주시면 감사하겠습니다.
                      </td>
                      <td rowspan="5">
                    ...
                    <tr>
                      ...
                      <td>고담시 배트멘구 로빈동 고담중학교 체육관
                      </td>
                    </tr>
                    <tr>
                      <td>담당자 :
                      </td>
                      <td>김개똥 010-1234-1119
                      </td>
                    </tr>
